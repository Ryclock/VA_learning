...
namespace base64
{
    ...
    static inline void encode_data_block(int len, int start_pos, const unsigned char *data, unsigned char *char_array_3)
    {
        for (int j = 0; j < len; j++)
        {
    ...
    static inline void encode_transform_block(const unsigned char *char_array_3, unsigned char *char_array_4)
    {
    ...
    static inline void encode_join_block(int len, const unsigned char *char_array_4, std::string &encoded_str)
    {
        for (int j = 0; j < len; j++)
        {
    ...
    static inline void decode_data_block(int len, uint8_t *char_array_4)
    {
        for (int j = 0; j < len; j++)
        {
    ...
    static inline void decode_transform_block(const uint8_t *char_array_4, uint8_t *char_array_3)
    {
    ...
    static inline void decode_join_block(int len, const uint8_t *char_array_3, std::string &decoded_str)
    {
        for (int j = 0; j < len; j++)
        {
